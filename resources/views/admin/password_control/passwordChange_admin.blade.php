...
@include('static-layout/admin_sidebar')
					...
					<div class="containerMain">
						<div class="content">
							...
							<form autocomplete="off" method="post" action="{{ url('admin/save-change-password') }}" name="change-password" id="change-password">
				...
				$("#change-password").validate({
					rules: {
							...
							messages: {
								...
								new_password: "You haven't provided any password",
