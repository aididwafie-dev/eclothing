...
@include('static-layout/admin_sidebar')
					...
					<div class="containerMain">
						<div class="content">
							...
							<br/>
							<i class="fa fa-filter" aria-hidden="true"></i> <B>Generate Report With User Details: </B>
							<hr>
							<form autocomplete="off" method="post" action="{{ url('/uniform-report-with-user-details-unit') }}" name="order-report" id="order-report">
