@include('static-layout/not-logged-header')
		...
		<div class="banner">
			<div class="content content-log">
				...
				<form autocomplete="off" method="post" action="{{ url('/admin/login-check') }}" name="login-form" id="login-form">
				...
				<span><a href="{{ url('/admin/forgot-password') }}" class="redirect-link">Forgot Password?</a></span>
				<br/>
			...
			$(document).ready(function(){
				$("#login-form").validate({
					rules: {
							...
							messages: {
								username: "Enter your valid service ID",
